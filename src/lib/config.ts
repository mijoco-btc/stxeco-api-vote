...
export function setConfigOnStart() {
  ...
  CONFIG.mongoDbUrl = process.env[network + "_stxeco_mongoDbUrl"] || "";
  CONFIG.mongoDbName = process.env[network + "_stxeco_mongoDbName"] || "";
  CONFIG.mongoUser = process.env[network + "_stxeco_mongoUser"] || "";
  CONFIG.mongoPwd = process.env[network + "_stxeco_mongoPwd"] || "";
